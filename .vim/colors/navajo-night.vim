...
hi Normal ctermfg=White guifg=LightBlue guibg=#35536f
"hi Normal ctermfg=White guifg=LightBlue guibg=#35536
...
"hi Search term=reverse ctermbg=White ctermfg=Black cterm=reverse guibg=darkblue guifg=Yellow
hi Search term=reverse cterm=reverse guibg=LightBlue guifg=#35536f 
...
hi Comment term=bold ctermfg=darkblue guifg=LightGreen
